...
import { getRandomPrompt } from "../components/utils";
  ...
  const generateImg = async () => {
    if (form.prompt) {
      try {
        ...
        const response = await fetch("htpps//localhost:8080/api/v1/dalle", {
          method: "POST",
          headers: {
    ...
    <section className="max-w-7xl mx-auto">
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit} action="">
        <div className="flex flex-col gap-5">
          ...
          border-gray-300 text-gray-900s text-sm rounded-lg 
